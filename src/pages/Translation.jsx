...
// === Styled Layout ===
const TranslationContainer = styled.div`  max-width: 900px;
  margin: 2rem auto;
  padding: 1rem;
  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;`;

const CameraPlaceholder = styled.div`  display: flex;
...
const VideoFeed = styled.video`  width: 100%;
  max-width: 640px;
  border-radius: 16px;
...
const ngrokBase = "[https://c593-143-44-224-17.ngrok-free.app](https://c593-143-44-224-17.ngrok-free.app)"; // replace with your ngrok URL
...
return ( <TranslationContainer> <Navbar /> <CameraPlaceholder> <VideoFeed ref={videoRef} autoPlay playsInline muted /> </CameraPlaceholder>
